                            ...
                            <form class="mx-1 mx-md-4" action= "./insert" method="POST">
                                ...
                                <div class="d-flex flex-row align-items-center mb-4">
                                    <div class="form-outline flex-fill mb-0">
                                        ...
                                        <input type="text" id="form3Example1c" class="form-control" name="name" value="{{$user[0]['name']}}" />
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-row align-items-center mb-4">
                                    <div class="form-outline flex-fill mb-0">
                                        ...
                                        <input type="email" id="form3Example3c" class="form-control" name="email" value="{{$user[0]['email']}}"/>
                                    </div>
                                </div>
