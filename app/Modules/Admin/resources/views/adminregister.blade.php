...
<div class = "back">
    <a href="./login"><button class="btn btn-dark bt-lg">ADMIN LOGIN</button></a>
</div>

<div class="container custom-login" style="background-color:#1a170d3d;">
    <div class = "row">
        <div class="col-sm-12 text-centre">
            <span style="margin-left: 460px;font-size:40px;"><b>Admin Registration ? </b></span><br><br>
        </div><br>
                        ...
                        success:function(data){
                            ...
                            if($.isEmptyObject(data.error)){
                                if(data.success){
                                    ...
                                    window.location="{{route('adminloginview')}}";
                                }else{
                                    clearerror()
